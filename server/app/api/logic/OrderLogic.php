...
class OrderLogic extends BaseLogic
{
    ...
    {
        $result = (new Goods())->field('id,name,unit_id,image,price')
            ->append(['unit_desc'])
            ->where(['id'=>$goods['id']])
            ->findOrEmpty()
            ->toArray();
    ...
    public function detail($id)
    {
        $result = Order::where('id',$id)
            ->append(['appoint_time','appoint_week','door_time','order_status_desc','pay_way_desc','pay_btn','cancel_btn','del_btn','comment_btn','contact_btn','province','city','district'])
