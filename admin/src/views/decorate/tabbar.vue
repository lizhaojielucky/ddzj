<template>
    <div class="decoration-tabbar min-w-[800px]">
        <el-card shadow="never" class="!border-none flex-1" :body-style="{ height: '100%' }">
            <div class="flex h-full items-start">
                ...
                <div class="flex-1">
                    ...
                    <el-form label-width="auto" :rules="rules" :model="tabbar" ref="ruleFormRef">
                        <el-tabs model-value="content">
                            ...
                            <el-tab-pane label="样式设置" name="styles">
                                <el-form-item label="默认颜色" required>
                                    <div>
                                ...
                                <el-form-item label="选中颜色" required>
                                    <div>
                                        <el-form-item prop="selectedColor">
                                            <div>
                                                <color-picker
                                                    class="max-w-[400px]"
                                                    v-model="tabbar.style.selectedColor"
                                                    default-color="#EA5455"
                                                />
                                                <div class="form-tips block">
                                                    导航文本选中时的颜色
                                                </div>
        ...
        <footer-btns class="mt-4" :fixed="false" v-perms="['decorate.tabbar/save']">
            <el-button type="primary" @click="setData(ruleFormRef)">保存</el-button>
        </footer-btns>
    </div>
</template>
...
const rules = reactive<FormRules>({
    defaultColor: [{ message: 'Please input Activity name', trigger: 'change' }],
    selectedColor: [{ message: 'Please input Activity name', trigger: 'change' }]
})
...
const setData = async () => {
    if (tabbar.style.defaultColor == '' || tabbar.style.selectedColor == '') {
        feedback.msgError('底部导航文字颜色不能为空！')
        return
    }
