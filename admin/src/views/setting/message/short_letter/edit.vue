        ...
        >
            <el-form ref="formRef" :model="formData" label-width="120px" :rules="formRules">
                ...
                <el-form-item
                    label="APP_KEY"
                    prop="app_key"
                    v-if="formData.alias == 'ali' || formData.alias == 'huawei'"
                >
                    <el-input v-model="formData.app_key" placeholder="请输入APP_KEY" />
                </el-form-item>
                <el-form-item label="APP_ID" prop="app_id" v-if="formData.alias == 'tencent'">
                    <el-input v-model="formData.app_id" placeholder="请输入APP_ID" />
                </el-form-item>
                <el-form-item label="SECRET_ID" prop="secret_id" v-if="formData.alias == 'tencent'">
