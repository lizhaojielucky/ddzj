<template>
    ...
    >
        <view class="order_detail">
            ...
            <view class="flex pb-[30rpx]">
                ...
                ></image>
                <text class="ml-[15rpx] text-white">{{ orderData.order_status_desc }}</text>
            </view>
            ...
            <view class="card">
                <view class="card--header">
                    <view class="title text-black"
                        >{{ orderData.contact }} {{ orderData.mobile }}</view
                    >
                </view>
                ...
                <view class="card normal text-base">
                    ...
                    <view class="pt-[40rpx] flex justify-center">
                        <qrcode
                            ref="qrcode"
                            uni="px"
                            :val="orderData.verification_code"
                            :size="118 * 2"
                            :showLoading="false"
                        />
                    </view>
                    ...
                    <view class="text-center p-[20rpx]">
                        核销码：{{ orderData.verification_code }}
                    </view>
                </view>
            </template>
    ...
    <!-- Footer Start -->
    <view class="footer flex justify-end" v-if="!orderData.del_btn">
        <order-footer
            :orderId="orderData.id"
            :cancel="orderData.cancel_btn"
            :del="orderData.del_btn"
            :evaluate="orderData.comment_btn"
            :contact="orderData.contact_btn"
            :pay="orderData.pay_btn"
            :mobile="orderData?.staff?.mobile"
            :type="2"
